 ...
 */
public abstract class CountDownTimerDojo {
     ...
     */
    public CountDownTimerDojo(long millisOnTimer, long countDownInterval, boolean runAtStart) {
     ...
     */
    public synchronized final CountDownTimerDojo create() {
     ...
     */
    public abstract void onFinish(Object o);
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            synchronized (CountDownTimerDojo.this) {
    ...
    public abstract void addPainel(TextView textView);
}